    ...
    <>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.brobo.user"
          ...
          <div class="md:w-1/2 text-right">
            <img src='https://i.pinimg.com/564x/a8/55/b1/a855b10983b0798c4b2dffd4517df60c.jpg' alt="About Image" class="w-full h-auto mt-4" />
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 ml-20">About Brobo</h4>
          <p className="text-gray-700 ml-20 text-xl">
            Brobo is an innovative event management company dedicated to transforming your vision into unforgettable experiences. We specialize in organizing and managing a wide range of events, from corporate gatherings and conferences to weddings and private parties. Our comprehensive services include venue selection, event design, logistics coordination, vendor management, and on-site support, ensuring every detail is meticulously handled. With a team of creative professionals and a commitment to excellence, Brobo delivers seamless, stress-free events that exceed expectations and leave lasting impressions.
          </p>
        </div>
        ...
        <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: "url('https://i.pinimg.com/564x/3f/67/8e/3f678e4d9c1b467ac5755766e88b2ac9.jpg')" }}>
          <div className="bg-black bg-opacity-50 p-8">
            ...
            <p className="text-lg mt-8 ml-24">
              In today's fast-paced world, the demand for seamless event management <br />solutions is more critical than ever. Clients and attendees alike expect high-quality,<br /> professionally executed events that are both engaging and memorable.<br /> Businesses are increasingly seeking innovative ways to host conferences,<br /> product launches, and corporate gatherings that reflect their brand and values.<br /> Similarly, individuals planning personal celebrations such as weddings or milestone<br /> parties desire flawless execution and creative flair. Brobo steps in to bridge this gap<br /> by offering comprehensive event management services that cater to these<br /> evolving needs. By leveraging technology and industry expertise, Brobo ensures <br />that every event, whether large or small, is executed with precision, creativity,<br /> and a keen attention to detail.
            </p>
      ...
      <div className="text-black p-8">
        <h2 className="text-4xl font-bold mt-[38rem] text-center">Client Goals</h2>
        <p className="text-lg mt-6 text-center max-w-4xl mx-auto">

          Our client's goal was to swiftly implement an event management solution that would enable organizers to extend their reach. By providing comprehensive planning and coordination services, the solution aims to enhance event accessibility and efficiency, ultimately reducing the strain on both corporate and personal event planners.
        </p>
        ...
        <ul className="list-disc list-inside text-lg mt-4 max-w-4xl ml-24 ">
          <li className="text-black">Deliver seamless event planning and execution</li>
          <li className="text-black">Increase client and attendee engagement</li>
          <li className="text-black">Improve accessibility to high-quality event services</li>
          ...
          <li className="text-black">Reduce event-related costs and stress for clients</li>
        </ul>
      </div>
