      ...
      <div className='mybg'>
        ...
        <div className="flex items-center justify-center mybg sm:mt-0">
          <div className="mybg p-6  sm:text-center sm:w-1/2 sm:mx-auto ">
            <h1 className="text-3xl text-center font-bold  text-black mt-36">"Our Teams"</h1>
            ...
            <h1 className="sm:text-xl font-semibold mb-4 text-black text-center  mt-12">Mohit Shrivastava, (CEO)<br />
