    ...
    <>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
            <h1 class="text-5xl font-bold mb-4 text-white ">YML MART</h1>
            ...
            <h3 class="sm:text-2xl text-white mt-3">
              <Link to="/" class="text-red-600 hover:underline">Home</Link> / YML
            </h3>
          </div>
          <div class="md:w-1/2 text-right">
            <img src='https://i.pinimg.com/736x/bf/d5/41/bfd541e8c35a90bab7c438988c2436c0.jpg' alt="About Image" class="w-full h-auto mt-4" />
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 ml-20">About YML</h4>
          <p className="text-gray-700 ml-20 text-xl">
          YML is a versatile platform designed for ordering daily use items with ease. Our platform offers a seamless experience for users to browse, select, and purchase a wide range of everyday essentials from groceries to household products. Customers benefit from a user-friendly interface that supports quick navigation, personalized recommendations, and secure transactions. YML ensures convenience by providing flexible delivery options and reliable customer support, making it effortless to meet your daily needs from the comfort of your home.
          </p>
        </div>
      ...
      <div className=" text-white font-sans min-h-screen">
        <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: "url('https://i.pinimg.com/564x/3f/67/8e/3f678e4d9c1b467ac5755766e88b2ac9.jpg')" }}>
          <div className="bg-black bg-opacity-50 p-8">
            ...
            The urgent integration of digital solutions into daily life has become<br/> more crucial than ever before. In retail settings, there is a growing recognition<br/> of the benefits of online platforms in enhancing shopping convenience and<br/> accessibility. Consumers are increasingly turning to technologies that simplify<br/> the process of ordering daily essentials and meeting their household needs,<br/> adapting to the changing demands of modern lifestyles. In response to these<br/> consumer challenges, our client swiftly introduced YML, an innovative app designed<br/> for users to effortlessly order a wide range of daily use items. This versatile solution<br/> supports customers in browsing products, making secure transactions.
            </p>
      ...
      <div className="text-black p-8">
        ...
        Our client's objective was to swiftly launch YML, an advanced app designed to revolutionize the way users order daily essentials.
        </p>
        ...
        <ul className="list-disc list-inside text-lg mt-4 max-w-4xl ml-24 ">
          ...
          <li className="text-black">Improve Accessibility to Daily Essentials</li>
          <li className="text-black">Ensure Timely Delivery and Customer Satisfaction</li>
          <li className="text-black">Streamline Ordering Process</li>
          <li className="text-black">Offer Cost-Effective Shopping Solutions</li>
        </ul>
      </div>
          ...
          <div className="bg-black bg-opacity-50 p-7">
            ...
            <div className="relative h-36">
              <img
                ...
                alt="Image 1"
                className="absolute w-[31rem] h-[25rem] left-[44rem] bottom-[30rem] transform translate-x-4 translate-y-4"
              />
              <img
