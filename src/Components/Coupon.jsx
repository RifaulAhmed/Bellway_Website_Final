    ...
    <>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
            <h1 class="text-5xl font-bold mb-4 text-white ">Coupon Counter</h1>
            ...
            <h3 class="sm:text-2xl text-white mt-3">
              <Link to="/" class="text-red-600 hover:underline">Home</Link> / Coupon Counter
            </h3>
          </div>
          <div class="md:w-1/2 text-right">
            <img src='https://i.pinimg.com/564x/33/d7/67/33d767d764cd48c59753ff5cb54523e1.jpg' alt="About Image" class="w-full h-auto mt-4" />
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 ml-20">About Coupon Counter</h4>
          <p className="text-gray-700 ml-20 text-xl">
          Coupon Counter is a premier online platform specializing in booking coupons for a wide range of events. Our service allows users to easily browse and purchase event coupons, providing convenient access to popular events such as concerts, theater performances, sporting events, and more. Whether you're planning a night out with friends, a family outing, or a special occasion, Coupon Counter offers a user-friendly interface that simplifies the booking process. Users can search for coupons based on event type, location, and date, ensuring they find the perfect tickets to suit their preferences.
          </p>
        </div>
      ...
      <div className=" text-white font-sans min-h-screen">
        <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: "url('https://i.pinimg.com/564x/3f/67/8e/3f678e4d9c1b467ac5755766e88b2ac9.jpg')" }}>
          <div className="bg-black bg-opacity-50 p-8">
            ...
            <p className="text-lg mt-7 ml-24">
            Coupon Counter is a major online platform that enables the easy booking <br/> of event coupons. This new service intends to improve access to a wide range <br/> of events, including concerts, theater performances, and sporting events, by<br/> offering users a simple and secure booking experience. Coupon Counter's <br/> comprehensive search capabilities and secure payment choices provide a <br/>hassle-free booking experience, catering to a wide range of event preferences<br/> and assuring complete client satisfaction.Coupon Counter revolutionizes the <br/>way people access and enjoy events by providing a streamlined platform for <br/>booking event coupons online. Whether you're planning a night out with friends, <br/>attending a cultural event, or catching your favorite team in action,<br/> Coupon Counter offers a comprehensive selection of tickets and coupons<br/> to suit every interest. 
            </p>
           <br/>
      ...
      <div className="text-black p-8">
        ...
        Our client's objective was to swiftly launch Coupon Counter, an innovative online platform dedicated to simplifying the booking of event coupons. This new service aims to enhance accessibility to a wide range of events.
        </p>
        ...
        <ul className="list-disc list-inside text-lg mt-4 max-w-4xl ml-24 ">
          <li className="text-black">Simplify online booking of event coupons</li>
          <li className="text-black">Engage users with intuitive interface.</li>
          <li className="text-black">Increase access to diverse events: concerts, sports</li>
          <li className="text-black">Provide accurate ticket availability and booking details</li>
          <li className="text-black">Streamline booking with advanced filters and secure payments</li>
          <li className="text-black">Offer savings through discounts and special offers</li>
        </ul>
      </div>
          ...
          <div className="bg-black bg-opacity-50 p-7">
            ...
            <div className="relative h-36">
              <img
                ...
                alt="Image 1"
                className="absolute w-[30rem] h-[33rem] left-[44rem] bottom-[27rem] transform translate-x-4 translate-y-4"
              />
              <img
              ...
              <img
                src={brobo4}
                alt="Image 3"
                className="absolute w-[16rem] h-[34rem] left-[5rem] top-66 transform translate-x-4 translate-y-4 border-4 border-black rounded-lg"
              />
               <img
                src={brobo8}
                alt="Image 3"
                className="absolute w-[16rem] h-[34rem] left-[30rem] top-[4rem] transform translate-x-4 translate-y-4 border-4 border-black rounded-lg"
              />
                <img
                src={brobo9}
                alt="Image 3"
                className="absolute w-[16rem] h-[34rem] left-[54rem] top-[0rem] transform translate-x-4 translate-y-4 border-4 border-black rounded-lg"
              />
                <img
                src={brobo6}
                alt="Image 4"
                className="absolute w-[16rem] h-[34rem] left-[5rem] top-[37rem] transform translate-x-4 translate-y-4 border-4 border-black rounded-lg"
              />
               <img
                src={brobo7}
                alt="Image 5"
                className="absolute w-[16rem] h-[34rem] left-[30rem] top-[40rem] transform translate-x-4 translate-y-4 border-4 border-black rounded-lg"
              />
                <img
                src={brobo5}
                alt="Image 6"
                className="absolute w-[16rem] h-[34rem] left-[54rem] top-[36.6rem] transform translate-x-4 translate-y-4   border-4 border-black rounded-lg"
              />
                  {/* <img
                src={brobo10}
                alt="Image 7"
