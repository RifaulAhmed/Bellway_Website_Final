    ...
    <>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
            <h1 class="text-5xl font-bold mb-4 text-white ">Oneapp Plus</h1>
            ...
            <h3 class="sm:text-2xl text-white mt-3">
              <Link to="/" class="text-red-600 hover:underline">Home</Link> / Oneapp Plus
            </h3>
          </div>
          <div class="md:w-1/2 text-right">
            <img src='https://i.pinimg.com/564x/66/66/e6/6666e66640af828ff4d8cdb6cdfdc36b.jpg' alt="About Image" class="w-full h-auto mt-4" />
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 ml-20">About Oneapp Plus</h4>
          <p className="text-gray-700 ml-20 text-xl">
          One App Plus is a premier e-commerce app designed to offer users a seamless shopping experience. Our platform brings a diverse range of products to your fingertips, from electronics and fashion to home essentials and more. Whether you're looking to upgrade your gadgets, refresh your wardrobe, or enhance your living space, One App Plus provides easy navigation and secure transactions. With features like personalized recommendations, exclusive deals, and reliable customer support, shopping becomes convenient and enjoyable. Discover the convenience of shopping everything you need in one place with One App Plus.
          </p>
        </div>
      ...
      <div className=" text-white font-sans min-h-screen">
        <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: "url('https://i.pinimg.com/564x/3f/67/8e/3f678e4d9c1b467ac5755766e88b2ac9.jpg')" }}>
          <div className="bg-black bg-opacity-50 p-8">
            ...
            In today's dynamic and fast-paced world, consumers increasingly <br/> seek convenience and reliability in their shopping experiences.<br/> They desire a platform that offers a wide array of products and services<br/> conveniently accessible from one place. The demand for personalized <br/> shopping experiences, where users can easily find products tailored to their<br/> preferences, is on the rise. People are looking for a trustworthy e-commerce <br/>solution that not only offers a diverse selection of goods but also ensures <br/>seamless transactions and excellent customer service. Recognizing this demand,<br/> our client launched One App Plus, an innovative e-commerce app designed to <br/>provide users with a comprehensive shopping experience.
            </p>
...
Our client's goal in launching One App Plus was to swiftly introduce an e-commerce platform that offers users seamless access to a wide range of products and services.
        </p>
        ...
        <ul className="list-disc list-inside text-lg mt-4 max-w-4xl ml-24 ">
          ...
          <li className="text-black">Ensure Secure and Convenient Transactions</li>
        </ul>
      </div>
