...
import screen from '../assets/Maza1.png'
import screen1 from '../assets/Maza2.png'
import screen2 from '../assets/Maza3.png'
import screen3 from '../assets/hotel5.png'
import brobo4 from '../assets/Maza4.png'
import brobo5 from '../assets/Maza5.png'
import brobo6 from '../assets/Maza6.png'
import brobo7 from '../assets/Maza7.png'
import brobo8 from '../assets/Maza8.png'
    ...
    <>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
            <h1 class="text-5xl font-bold mb-4 text-white ">Maza Munch</h1>
            ...
            <h3 class="sm:text-2xl text-white mt-3">
              <Link to="/" class="text-red-600 hover:underline">Home</Link> / Maza Munch
            </h3>
          </div>
          <div class="md:w-1/2 text-right">
            <img src='https://i.pinimg.com/736x/57/4f/ff/574fffd52d97107c86d89b8ce9d7e8fe.jpg' alt="About Image" class="w-full h-auto mt-4" />
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 ml-20">About Maza Munch</h4>
          <p className="text-gray-700 ml-20 text-xl">
          Maza Munch is a user-friendly food ordering platform that connects users with nearby restaurants, allowing them to browse and order their favorite meals with ease. The app simplifies the dining experience by offering features like real-time menu updates, customizable order options, and secure payment methods. Users can search for restaurants based on cuisine, location, or popularity, and can opt for delivery or pickup. Maza Munch aims to enhance customer satisfaction by providing a convenient, accessible, and enjoyable way to discover and enjoy delicious food from local eateries.
          </p>
        </div>
      ...
      <div className=" text-white font-sans min-h-screen">
        <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: "url('https://i.pinimg.com/564x/3f/67/8e/3f678e4d9c1b467ac5755766e88b2ac9.jpg')" }}>
          <div className="bg-black bg-opacity-50 p-8">
            ...
            The demand for convenient food delivery services is at an all-time high,<br/> with customers seeking quick and easy access to their favorite meals from <br/>local restaurants. In today's fast-paced world, convenience and reliability in <br/> ordering services are essential. A significant majority of consumers prefer to<br/> order their food through a trusted platform that guarantees timely delivery <br/> and high-quality meals. This growing preference highlights the necessity for<br/> a comprehensive food ordering solution. Responding to this demand, our client <br/>swiftly launched Maza Munch, a platform designed to provide effortless <br/> ordering from nearby restaurants.
            </p>
      ...
      <div className="text-black p-8">
        ...
        Our client's goal was to swiftly implement a food ordering solution that would enable customers to access meals from nearby restaurants with ease.
        </p>
        ...
        <ul className="list-disc list-inside text-lg mt-4 max-w-4xl ml-24 ">
          <li className="text-black">Offer seamless food ordering from nearby restaurants</li>
          <li className="text-black">Enhance customer engagement and satisfaction</li>
          <li className="text-black">Improve accessibility to a variety of local cuisines</li>
          <li className="text-black">Provide personalized meal recommendations</li>
      ...
      <div className=" text-white font-sans min-h-screen">
        <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: "url('https://i.pinimg.com/564x/25/d0/cf/25d0cfcd1837ab7001ca80de76b9e619.jpg')" }}>
          <div className="bg-black bg-opacity-50 p-7">
            ...
            <div className="relative h-36">
              <img
                src='https://i.pinimg.com/736x/7f/92/3d/7f923dfb85a95211de661c61fcb7f2ed.jpg'
                alt="Image 1"
                className="absolute w-[29rem] h-[34rem] left-[44rem] bottom-[27rem] transform translate-x-4 translate-y-4"
              />
              <img
                src='https://i.pinimg.com/564x/17/7f/4f/177f4f48c6fc5b6112b659574f22e752.jpg'
                alt="Image 2"
              ...
              />
                ...
                src={brobo7}
                alt="Image 4"
                className="absolute w-[16rem] h-[34rem] left-[15rem] top-[40rem] transform translate-x-4 translate-y-4"
              />
               <img
                src={brobo8}
                alt="Image 5"
                className="absolute w-[16rem] h-[34rem] left-[45rem] top-[40rem] transform translate-x-4 translate-y-4"
              />
