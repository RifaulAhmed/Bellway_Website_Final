    ...
    <>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
            <h1 class="text-5xl font-bold mb-4 text-white ">DESIGRO</h1>
            ...
            <h3 class="sm:text-2xl text-white mt-3">
              <Link to="/" class="text-red-600 hover:underline">Home</Link> / Desigro
            </h3>
          </div>
          <div class="md:w-1/2 text-right">
            <img src='https://i.pinimg.com/564x/ee/73/35/ee7335df2acfac254003669aaf8e2dec.jpg' alt="About Image" class="w-full h-auto mt-4" />
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 ml-20">About Desi Gro</h4>
          <p className="text-gray-700 ml-20 text-xl">
          Desi Gro is a convenient online platform dedicated to simplifying the purchase of fresh milk and dairy products. Users can easily register and access a variety of dairy options through the app. Designed with user convenience in mind, Desi Gro ensures a seamless shopping experience with features such as easy navigation, secure payment options, and personalized delivery schedules. Customers can select their preferred milk type, quantity, and delivery frequency, making it effortless to ensure a steady supply of fresh dairy products directly to their doorstep.
      ...
      <div className=" text-white font-sans min-h-screen">
        <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: "url('https://i.pinimg.com/564x/3f/67/8e/3f678e4d9c1b467ac5755766e88b2ac9.jpg')" }}>
          <div className="bg-black bg-opacity-50 p-8">
            ...
            The urgent integration of traditional dairy supply with modern technology<br/> has become more critical than ever. In the United States, there is a significant<br/> demand for convenient access to fresh dairy products, highlighting a growing<br/> preference for streamlined solutions in grocery shopping. Additionally, consumers <br/>are increasingly seeking reliable platforms that offer secure transactions and <br/> personalized delivery options, ensuring a consistent supply of quality dairy products<br/> directly to their homes.

In response to these evolving needs, Desi Gro swiftly<br/> launched its innovative app, providing a seamless online platform for booking<br/> fresh milk and dairy products.
            </p>
      ...
      <div className="text-black p-8">
        ...
        Our client's objective was to swiftly introduce Desi Gro, an innovative app designed to streamline the online booking of milk and dairy products. This solution aims to enhance accessibility to fresh dairy products 
        </p>
        ...
        <ul className="list-disc list-inside text-lg mt-4 max-w-4xl ml-24 ">
          <li className="text-black">Simplify online booking of milk and dairy products</li>
          <li className="text-black">Personalize shopping experiences to enhance engagement</li>
          <li className="text-black">Increase access to fresh dairy products</li>
          <li className="text-black">Provide accurate product details and dependable delivery</li>
          <li className="text-black">Streamline shopping with intuitive app navigation</li>
          <li className="text-black">Offer cost-effective dairy purchasing solutions</li>
        </ul>
      </div>
          ...
          <div className="bg-black bg-opacity-50 p-7">
            ...
            <div className="relative h-36">
              <img
                ...
                alt="Image 1"
                className="absolute w-[32rem] h-[33rem] left-[44rem] bottom-[27rem] transform translate-x-4 translate-y-4"
              />
              <img
