...
const Brobo = () => {
  return (
    <>
      ...
      <div class="containerx mx-auto bg-black p-8">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
            <h1 class="text-5xl font-bold mb-4 text-white ">Online Web Store</h1>
            ...
            <h3 class="sm:text-2xl text-white mt-3">
              <Link to="/" class="text-red-600 hover:underline">Home</Link> / Online Store Web
            </h3>
          </div>
          <div class="md:w-1/2 text-right">
            <img src='https://i.pinimg.com/736x/71/1d/91/711d9117916487022091b95388520fc1.jpg' alt="About Image" class="w-full h-auto mt-4" />
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-8">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h4 className="text-3xl font-bold mb-4 ml-20">About Online Store Web</h4>
          <p className="text-gray-700 ml-20 text-xl">
          Online Web Store is an innovative platform dedicated to providing fresh and high-quality vegetables directly to customers' doorsteps. Our web store offers a convenient and reliable solution for ordering vegetables online, ensuring freshness and nutritional value with every purchase. Customers can explore a wide variety of locally sourced produce, conveniently categorized for easy selection. Whether you're looking for organic greens, seasonal favorites, or specialty herbs, Online Web Store guarantees prompt delivery and seamless transactions. With features like flexible delivery schedules, secure payment options, and personalized customer service.
          </p>
        </div>
      ...
      <div className="text-black p-8">
        ...
        Our client's goal was to swiftly implement an online web store solution that would enable customers to conveniently order fresh vegetables.
        </p>
    ...
    <div className="bg-gray-100">
            <div className="hero-section relative h-[30rem] flex mt-12 "
                 style={{ backgroundImage: "url('https://i.pinimg.com/564x/3b/49/04/3b4904d15ee802e70915990451ab1440.jpg')", backgroundSize: "cover", backgroundPosition: "center center" }}>
                <div className="max-w-3xl mx-auto text-left text-white p-8 mt-[12rem] ">
                    <h1 className="text-3xl sm:text-4xl font-bold mb-4 ml-[-29rem]">Aiming to turn your visitors <br/> into loyal customers?</h1>
                    <p className="text-lg mb-6 ml-[-29rem]">Hire our eCommerce product development experts, who can match your quality standards,<br/> boost customer engagement, and build a loyal customer base.</p>
                    <a style={{borderRadius:'1px'}} href="#" className="bg-red-700 hover:bg-red-800 text-white font-bold py-3 px-3 rounded-full shadow-lg uppercase ml-[-29rem]">Contact Us</a>
                </div>
            </div>
        </div>
      <Footer/>
