...
const Product2 = () => {
    ...
    return (
        <>
            <Helmet>
                <title>BELLWAY INFOTECH Offers Top-Tier Online Bell Store Services.</title>
                <meta name="description" content="Bellway Infotech Offers Top-Tier Online Bell Store Services. Experience a seamless, user-friendly platform for all your needs. Shop smart, shop easy." />
            </Helmet>
