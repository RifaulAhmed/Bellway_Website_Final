...
const Product2 = () => {
    ...
    return (
        <>
        <Helmet>
                <title>BELLWAY INFOTECH | Most Delicious Meal Delivery Excellence</title>
                <meta name="description" content="Experience the Most Delicious Meal Delivery Excellence with Bellway Infotech. Experience excellence with us today and indulge in culinary perfection. Shop  Now!" />
